          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#E4405F] hover:border-[#E4405F]/30 hover:bg-[#E4405F]/10 transition-all"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#EE1D52] hover:border-[#EE1D52]/30 hover:bg-[#EE1D52]/10 transition-all"
              >
                <TiktokIcon size={18} />
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-[#FF0000] hover:border-[#FF0000]/30 hover:bg-[#FF0000]/10 transition-all"
              >
                <YoutubeIcon size={18} />
              </motion.a>
            </div>
